                  ...
                  <div className="border-b border-slate-100">
                    ...
                    {openCategory === 'datos' && (
                        <div className="bg-slate-50 divide-y divide-slate-100">
                            ...
                            <button onClick={() => handleAdminNavigate(ViewState.ADMIN_MANAGE_PROVIDERS)} className="w-full text-left pl-14 py-3 text-xs font-bold text-slate-600 hover:bg-white flex items-center gap-2"><Truck size={14} className="text-blue-400" /> Gestión de Proveedores</button>
